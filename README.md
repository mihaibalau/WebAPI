...
├── Properties
│   └── launchSettings.json          # Defines profiles for local launch (e.g., ports, environment)
├── README.md                        # Project documentation and instructions
├── WebApi.csproj                    # C# project file with references and build settings
├── WebApi.sln                       # Solution file for the project
├── appsettings.Development.json     # App settings specific to Development environment
├── appsettings.json                 # Main app configuration (connection strings, logging, etc.)
